  ...
  return (
    <footer className="z-1 relative">
      <Container>
        ...
        <div className="flex flex-col items-center border-gray-200/20 pt-8 pb-12 sm:border-t md:flex-row-reverse md:justify-between md:pt-6">
          ...
          {/* <form className="flex justify-center w-full md:w-auto">
            ...
            <Button type="submit" color="cyan" className="flex-none ml-4">
              ...
              <span className="lg:hidden">Abonner på vårt nyhetsbrev</span>
            </Button>
          </form> */}
          <p className="mt-6 text-sm text-gray-300 md:mt-0">
