  ...
  return (
    <div className="relative flex min-h-screen">
      ...
      <div className="absolute inset-0 sm:hidden">
        <Image
          src="https://res.cloudinary.com/dt3k2apqd/image/upload/q_auto/My%20Next%20Coffee/My_Next_Coffee_mobile_fwwwwq.webp"
          alt="Indulge in the rich and diverse flavours of coffee beans from My Next Coffee"
          fill
          className="h-full w-full object-cover"
          unoptimized
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-stone-900/90 sm:hidden" />
      <div className="absolute inset-0 bg-gradient-to-t from-stone-900/90 sm:hidden" />
        ...
        <Container className="w-full">
          <div className="flex flex-col justify-between space-y-40">
            <div className="">
              ...
              <div className="my-12 mb-72 max-w-2xl font-light sm:my-24 sm:mb-0 sm:prose lg:prose-xl">
